...
var TreeStore = /** @class */ (function (_super) {
    ...
    TreeStore.prototype.translateAttribute = function (filter, attr, context, option) {
                            ...
                            return __generator(this, function (_e) {
                                switch (_e.label) {
                                    ...
                                    case 12:
                                        ...
                                        return [3 /*break*/, 17];
                                    case 13:
                                        if (!option.obscure) return [3 /*break*/, 14];
                                                ...
                                                return __generator(this, function (_a) {
                                                    switch (_a.label) {
                                                        case 0:
                                                            ...
                                                            return [4 /*yield*/, this.selectAbjointRow(inData_1.entity, inData_1, context, option)];
                                                        case 1:
                                                            ...
                                                            (0, lodash_1.unset)(option, 'nodeDict');
                                                ...
                                                return __generator(this, function (_a) {
                                                    switch (_a.label) {
                                                        case 0:
                                                            ...
                                                            return [4 /*yield*/, this.selectAbjointRow(inData_2.entity, inData_2, context, option)];
                                                        case 1:
                                                            legalSets = (_a.sent()).map(function (ele) {
                                                                var data = inData_2.data;
                                                                var key = Object.keys(data)[0];
                            ...
                            return __generator(this, function (_f) {
                                switch (_f.label) {
                                    ...
                                    case 4:
                                        ...
                                        // 行本身的属性
                                        _e = (_d = fns).push;
                                        return [4 /*yield*/, this_2.translateAttribute(filter[attr], attr, context, option)];
                                    case 5:
                                        // 行本身的属性
                                        _e.apply(_d, [_f.sent()]);
                                        return [3 /*break*/, 10];
