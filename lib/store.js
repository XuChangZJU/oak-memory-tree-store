...
var TreeStore = /** @class */ (function (_super) {
     ...
     * @returns
     */
    TreeStore.prototype.getEntityNodes = function (entity, selection) {
        if (this.store[entity]) {
            var filter = selection.filter;
            if ((filter === null || filter === void 0 ? void 0 : filter.id) && (typeof filter.id === 'string' || typeof filter.id === 'object' && typeof filter.id.$in === 'object')) {
                var ids = typeof filter.id === 'string' ? [filter.id] : filter.id.$in;
    ...
    TreeStore.prototype.selectAbjointRow = function (entity, selection, context, option) {
        ...
        var entityNodes = this.getEntityNodes(entity, selection);
        var nodes = [];
        try {
