...
var TreeStore = /** @class */ (function (_super) {
                ...
                switch (_s.label) {
                    ...
                    case 1:
                        ...
                        if (this.store[entity] && (this.store[entity])[id]) {
                            ...
                            if (option === null || option === void 0 ? void 0 : option.allowExists) {
                                data2_1 = Object.assign(data, node.$next, {
                    ...
                    case 9:
                        ...
                        ids.forEach(function (id) {
                            ...
                            if (action === 'remove') {
                                ...
                                var data2 = Object.assign(data, node.$next, {
                                    $$updateAt$$: data.$$updateAt$$ || now,
                                });
                                node.$next = data2;
                                if (!alreadyDirtyNode) {
    ...
    TreeStore.prototype.formResult = function (entity, rows, selection, context, nodeDict) {
        return __awaiter(this, void 0, void 0, function () {
            var data, sorter, indexFrom, count, findAvailableExprName, sortToProjection, rows2, rows_2, rows_2_1, row, result, nodeDict2, e_11_1, sorterFn;
            var e_11, _a;
            var _this = this;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        _b.label = 2;
                    case 2:
                        if (!!rows_2_1.done) return [3 /*break*/, 5];
                        row = rows_2_1.value;
                        result = {};
                        nodeDict2 = {};
                        if (nodeDict) {
    ...
    TreeStore.prototype.sync = function (opRecords, context) {
        return __awaiter(this, void 0, void 0, function () {
            var opRecords_1, opRecords_1_1, record, _a, e, d, _b, e, d, f, _c, e, f, d, _d, _e, _i, entity, _f, _g, _h, id, e_12_1;
            var e_12, _j;
            return __generator(this, function (_k) {
                switch (_k.label) {
                    case 0:
                        _k.trys.push([0, 18, 19, 20]);
                        opRecords_1 = __values(opRecords), opRecords_1_1 = opRecords_1.next();
                        _k.label = 1;
                    case 1:
                        if (!!opRecords_1_1.done) return [3 /*break*/, 17];
