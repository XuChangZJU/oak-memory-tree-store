...
var TreeStore = /** @class */ (function (_super) {
            ...
            return tslib_1.__generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 1:
                        ...
                        _d.label = 2;
                    case 2:
                        if (!!entityNodes_1_1.done) return [3 /*break*/, 10];
                        ...
                        _d.label = 3;
                    case 3:
                        if (!(n.$txnId && n.$txnId !== context.getCurrentTxnId())) return [3 /*break*/, 5];
                        return [4 /*yield*/, this.waitOnTxn(n.$txnId, context)];
                    case 4:
                        _d.sent();
                        return [3 /*break*/, 3];
                    case 5:
                    ...
                    case 6: return [4 /*yield*/, (_d.sent())(n, nodeDict2, exprResolveFns)];
                    case 7:
                        _a = (_d.sent());
                        _d.label = 8;
                    case 8:
    ...
    TreeStore.prototype.formExprInResult = function (entity, projection, data, nodeDict, context) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var laterExprDict, _a, _b, _i, attr, ExprNodeTranslator, exprResult, nodeId, _loop_3, this_3, _c, _d, _e, attr, attr, exprResult;
            var _f, _g, _h, _j;
            var _this = this;
            return tslib_1.__generator(this, function (_k) {
                switch (_k.label) {
                    ...
                    case 1:
                        ...
                        ExprNodeTranslator = this.translateExpression(entity, projection[attr], context, {});
                        return [4 /*yield*/, ExprNodeTranslator(data, nodeDict)];
                    case 2:
                        exprResult = _k.sent();
                    ...
                    case 4:
                        ...
                        return [3 /*break*/, 1];
                    case 5:
                        _loop_3 = function (attr) {
                            var rel, result2;
                            return tslib_1.__generator(this, function (_l) {
                                switch (_l.label) {
                                    case 0:
                                        rel = this_3.judgeRelation(entity, attr);
                                        if (!(rel === 1)) return [3 /*break*/, 1];
                                        return [3 /*break*/, 9];
                                    case 1:
                                        if (!(rel === 2)) return [3 /*break*/, 4];
                                        if (!data[attr]) return [3 /*break*/, 3];
                                        return [4 /*yield*/, this_3.formExprInResult(attr, projection[attr], data[attr], nodeDict, context)];
                                    case 2:
                                        _l.sent();
                                        _l.label = 3;
                                    ...
                                    case 4:
                                        ...
                                        if (!data[attr]) return [3 /*break*/, 6];
                                        result2 = {};
                                        return [4 /*yield*/, this_3.formExprInResult(rel, projection[attr], data[attr], nodeDict, context)];
                                    case 5:
                                        _l.sent();
                                        _l.label = 6;
                                    case 6: return [3 /*break*/, 9];
                                    case 7:
                                        if (!(rel instanceof Array)) return [3 /*break*/, 9];
                                        if (!(data[attr] && data[attr] instanceof Array)) return [3 /*break*/, 9];
                                        return [4 /*yield*/, Promise.all(data[attr].map(function (ele) { return _this.formExprInResult(rel[0], projection[attr].data, ele, nodeDict, context); }))];
                                    case 8:
                                        _l.sent();
                                        _l.label = 9;
    ...
    TreeStore.prototype.formResult = function (entity, rows, selection, context) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var data, sorter, indexFrom, count, findAvailableExprName, sortToProjection, rows2, incompletedRowIds, projection, rows_1, rows_1_1, row, result, attr, rel, sorterFn;
            var e_11, _a, _b;
            var _this = this;
            return tslib_1.__generator(this, function (_c) {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        result = _a.sent();
                        // 在这里再计算所有的表达式
                        return [4 /*yield*/, this.formExprInResult(entity, selection.data, result, {}, context)];
                    case 2:
                        // 在这里再计算所有的表达式
                        _a.sent();
                        return [2 /*return*/, {
    ...
    TreeStore.prototype.sync = function (opRecords, context, option) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var option2, opRecords_1, opRecords_1_1, record, _a, e, d, d_1, d_1_1, dd, e_14_1, _b, e, d, f, _c, e, f, d, _d, _e, _i, entity, _f, _g, _h, id, e_15_1;
            var e_15, _j, e_14, _k;
            return tslib_1.__generator(this, function (_l) {
                switch (_l.label) {
                    case 0:
                        ...
                        _l.label = 1;
                    case 1:
                        _l.trys.push([1, 35, 36, 37]);
                        opRecords_1 = tslib_1.__values(opRecords), opRecords_1_1 = opRecords_1.next();
                        _l.label = 2;
                    case 2:
                        if (!!opRecords_1_1.done) return [3 /*break*/, 34];
                        record = opRecords_1_1.value;
                        _a = record.a;
                        switch (_a) {
                            case 'c': return [3 /*break*/, 3];
                            case 'u': return [3 /*break*/, 19];
                            case 'r': return [3 /*break*/, 21];
                            case 's': return [3 /*break*/, 23];
                        }
                        return [3 /*break*/, 32];
                    case 3:
                        e = record.e, d = record.d;
                        if (!(d instanceof Array)) return [3 /*break*/, 14];
                        _l.label = 4;
                    case 4:
                        _l.trys.push([4, 11, 12, 13]);
                        d_1 = (e_14 = void 0, tslib_1.__values(d)), d_1_1 = d_1.next();
                        _l.label = 5;
                    case 5:
                        if (!!d_1_1.done) return [3 /*break*/, 10];
                        dd = d_1_1.value;
                        if (!(this.store[e] && this.store[e][dd.id])) return [3 /*break*/, 7];
                    ...
                    case 6:
                        _l.sent();
                        return [3 /*break*/, 9];
                    case 7: return [4 /*yield*/, this.updateAbjointRow(e, {
                            id: 'dummy',
                            action: 'create',
                            data: dd,
                        }, context, option2)];
                    ...
                    case 14:
                        if (!(this.store[e] && this.store[e][d.id])) return [3 /*break*/, 16];
                        return [4 /*yield*/, this.updateAbjointRow(e, {
                                id: 'dummy',
                                action: 'update',
                                data: d,
                    ...
                    case 15:
                        _l.sent();
                        return [3 /*break*/, 18];
                    case 16: return [4 /*yield*/, this.updateAbjointRow(e, {
                            id: 'dummy',
                            action: 'create',
                            data: d,
                        }, context, option2)];
                    ...
                    case 23:
                        ...
                        _l.label = 24;
                    case 24:
                        if (!(_i < _d.length)) return [3 /*break*/, 31];
                        entity = _d[_i];
                        _f = [];
                        for (_g in d[entity])
                            _f.push(_g);
                        ...
                        _l.label = 25;
                    case 25:
                        if (!(_h < _f.length)) return [3 /*break*/, 30];
                        id = _f[_h];
                        if (!(this.store[entity] && this.store[entity][id])) return [3 /*break*/, 27];
                    ...
                    case 26:
                        _l.sent();
                        return [3 /*break*/, 29];
                    case 27: return [4 /*yield*/, this.updateAbjointRow(entity, {
                            id: 'dummy',
                            action: 'create',
                            data: d[entity][id],
                        }, context, option2)];
