...
var TreeStore = /** @class */ (function (_super) {
    __extends(TreeStore, _super);
    function TreeStore(storageSchema, initialData, stat) {
    ...
    TreeStore.prototype.setInitialData = function (data) {
        var e_1, _a;
        for (var entity in data) {
            ...
            try {
                for (var _b = (e_1 = void 0, __values(data[entity])), _c = _b.next(); !_c.done; _c = _b.next()) {
                    var row = _c.value;
    ...
    TreeStore.prototype.translateLogicFilter = function (entity, filter, attr, context, params) {
        var _this = this;
        switch (attr) {
            case '$and': {
                var filters = filter[attr];
                var fns_1 = filters.map(function (ele) { return _this.translateFilter(entity, ele, context, params); });
                return function (node, nodeDict, exprResolveFns) { return __awaiter(_this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            case 0:
                                ...
                                fns_2 = __values(fns_1), fns_2_1 = fns_2.next();
                                _b.label = 1;
                            case 1:
            ...
            case '$or': {
                var filters = filter[attr];
                var fns_3 = filters.map(function (ele) { return _this.translateFilter(entity, ele, context, params); });
                return function (node, nodeDict, exprResolveFns) { return __awaiter(_this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            case 0:
                                _b.trys.push([0, 6, 7, 8]);
                                fns_4 = __values(fns_3), fns_4_1 = fns_4.next();
                                _b.label = 1;
                            case 1:
            ...
            case '$not': {
                ...
                var fn_1 = this.translateFilter(entity, filter2, context, params);
                return function (node, nodeDict, exprResolveFns) { return __awaiter(_this, void 0, void 0, function () {
     ...
     * @returns
     */
    TreeStore.prototype.translateExpressionNode = function (entity, expression, context, params2) {
        var _this = this;
        if ((0, Expression_1.isExpression)(expression)) {
            var op_1 = Object.keys(expression)[0];
            var params_1 = expression[op_1];
            if ((0, Expression_1.opMultipleParams)(op_1)) {
                var paramsTranslated_1 = params_1.map(function (ele) { return _this.translateExpressionNode(entity, ele, context, params_1); });
                return function (row, nodeDict) {
                    ...
                    if (!later) {
                        return (0, Expression_1.execOp)(op_1, results, params_1.obscure);
                    }
                    var laterCheckFn = function (nodeDict2) {
                        ...
                        return (0, Expression_1.execOp)(op_1, results, params2 && params2.obscure);
                    };
                    return laterCheckFn;
                };
            }
            else {
                var paramsTranslated_2 = this.translateExpressionNode(entity, params_1, context, params_1);
                if (typeof paramsTranslated_2 === 'function') {
                    return function (row, nodeDict) {
                        ...
                        return (0, Expression_1.execOp)(op_1, result, params_1.obscure);
                    };
                }
                else {
                    return function () {
                        return (0, Expression_1.execOp)(op_1, paramsTranslated_2, params_1.obscure);
                    };
                }
            }
        }
    ...
    TreeStore.prototype.translateExpression = function (entity, expression, context, params) {
        var _this = this;
        var expr = this.translateExpressionNode(entity, expression, context, params);
        return function (row, nodeDict) { return __awaiter(_this, void 0, void 0, function () {
            var result;
            return __generator(this, function (_a) {
    ...
    TreeStore.prototype.translateFulltext = function (entity, filter, context, params) {
        var _this = this;
        // 全文索引查找
            ...
            return __generator(this, function (_b) {
                ...
                try {
                    for (attributes_1 = __values(attributes), attributes_1_1 = attributes_1.next(); !attributes_1_1.done; attributes_1_1 = attributes_1.next()) {
                        ...
                        name_1 = attr.name;
                        if (row && row[name_1] && (typeof row[name_1] === 'string' && row[name_1].contains($search) || obscurePass(row, name_1, params))) {
                            return [2 /*return*/, true];
                        }
                    }
                }
    ...
    TreeStore.prototype.translateAttribute = function (filter, attr, context, params) {
        return __awaiter(this, void 0, void 0, function () {
            // 如果是模糊查询且该属性为undefined，说明没取到，返回true
            function obscurePassLocal(row) {
                return obscurePass(row, attr, params);
            }
            var fns, _loop_1, this_1, _a, _b, _i, op;
            var _this = this;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        if (typeof filter !== 'object') {
                            return [2 /*return*/, function (node) { return __awaiter(_this, void 0, void 0, function () {
                                    var row;
                                    return __generator(this, function (_a) {
                                        row = this.constructRow(node, context);
                        ...
                        fns = [];
                        _loop_1 = function (op) {
                            var _d, exists_1, inData_1, legalSets_1, err_1, inData_2, legalSets_2, err_2;
                            return __generator(this, function (_e) {
                                switch (_e.label) {
                                    ...
                                    case 1:
                                        {
                                            fns.push(function (row) { return __awaiter(_this, void 0, void 0, function () { return __generator(this, function (_a) {
                                    ...
                                    case 7:
                                        {
                                            fns.push(function (row) { return __awaiter(_this, void 0, void 0, function () {
                                                return __generator(this, function (_a) {
                                    ...
                                    case 11:
                                        {
                                            ...
                                            fns.push(function (row) { return __awaiter(_this, void 0, void 0, function () {
                                                return __generator(this, function (_a) {
                                                    if (exists_1) {
                                                        return [2 /*return*/, [null].includes(row[attr]) || obscurePassLocal(row)];
                                                    }
                                                    else {
                                    ...
                                    case 12:
                                        ...
                                        return [3 /*break*/, 17];
                                    case 13:
                                        if (!params.obscure) return [3 /*break*/, 14];
                                        fns.push(function () { return __awaiter(_this, void 0, void 0, function () { return __generator(this, function (_a) {
                                            return [2 /*return*/, true];
                                        }); }); });
                                        return [3 /*break*/, 17];
                                    case 14:
                                        _e.trys.push([14, 16, , 17]);
                                        return [4 /*yield*/, this_1.selectAbjointRow(inData_1.entity, inData_1, context, params)];
                                    case 15:
                                        legalSets_1 = (_e.sent()).map(function (ele) {
                                    ...
                                    case 16:
                                        ...
                                        if (err_1 instanceof OakError_1.OakError && err_1.$$code === RowStore_1.RowStore.$$CODES.expressionUnresolved[0]) {
                                            fns.push(function (row, nodeDict) { return __awaiter(_this, void 0, void 0, function () {
                                                var legalSets;
                                                return __generator(this, function (_a) {
                                                    switch (_a.label) {
                                                        case 0:
                                                            ...
                                                            return [4 /*yield*/, this.selectAbjointRow(inData_1.entity, inData_1, context, params)];
                                                        case 1:
                                    ...
                                    case 19:
                                        ...
                                        return [4 /*yield*/, this_1.selectAbjointRow(inData_2.entity, inData_2, context, params)];
                                    case 20:
                                        legalSets_2 = (_e.sent()).map(function (ele) {
                                                ...
                                                return __generator(this, function (_a) {
                                                    switch (_a.label) {
                                                        case 0:
                                                            ...
                                                            return [4 /*yield*/, this.selectAbjointRow(inData_2.entity, inData_2, context, params)];
                                                        case 1:
                                                            legalSets = (_a.sent()).map(function (ele) {
                                                                var data = inData_2.data;
                                                                var key = Object.keys(data)[0];
                    ...
                    case 3:
                        _i++;
                        return [3 /*break*/, 1];
                    case 4: return [2 /*return*/, function (node, nodeDict, exprResolveFns) { return __awaiter(_this, void 0, void 0, function () {
                            ...
                            return __generator(this, function (_b) {
                                switch (_b.label) {
                                    ...
                                    case 1:
                                        ...
                                        fns_5 = __values(fns), fns_5_1 = fns_5.next();
                                        _b.label = 2;
                                    case 2:
    ...
    TreeStore.prototype.translateFilter = function (entity, filter, context, params) {
        return __awaiter(this, void 0, void 0, function () {
                            ...
                            return __generator(this, function (_f) {
                                switch (_f.label) {
                                    ...
                                    case 1:
                                        ...
                                        fns.push(this_2.translateLogicFilter(entity, filter, attr, context, params));
                                        return [3 /*break*/, 10];
                                    case 2:
                                        if (!attr.toLowerCase().startsWith(Demand_1.EXPRESSION_PREFIX)) return [3 /*break*/, 3];
                                        fn_2 = this_2.translateExpression(entity, filter[attr], context, params);
                                        fns.push(function (node, nodeDict, exprResolveFns) { return __awaiter(_this, void 0, void 0, function () {
                                            var row, result;
                                            return __generator(this, function (_a) {
                                                switch (_a.label) {
                                                    case 0:
                                    ...
                                    case 3:
                                        ...
                                        fns.push(this_2.translateFulltext(entity, filter[attr], context, params));
                                        return [3 /*break*/, 10];
                                    case 4:
                                        ...
                                        // 行本身的属性
                                        _e = (_d = fns).push;
                                        return [4 /*yield*/, this_2.translateAttribute(filter[attr], attr, context, params)];
                                    case 5:
                                        // 行本身的属性
                                        _e.apply(_d, [_f.sent()]);
                                        return [3 /*break*/, 10];
                                    case 6:
                                        ...
                                        return [4 /*yield*/, this_2.translateFilter(attr, filter[attr], context, params)];
                                    case 7:
                                        fn_3 = _f.sent();
                                        fns.push(function (node, nodeDict, exprResolveFns) { return __awaiter(_this, void 0, void 0, function () {
                                            var row, node2;
                                    ...
                                    case 8:
                                        ...
                                        return [4 /*yield*/, this_2.translateFilter(relation_2, filter[attr], context, params)];
                                    case 9:
                                        fn_4 = _f.sent();
                                        fns.push(function (node, nodeDict, exprResolveFns) { return __awaiter(_this, void 0, void 0, function () {
                                            var row, node2;
                                            return __generator(this, function (_a) {
                                                row = this.constructRow(node, context);
                                                if (obscurePass(row, "".concat(attr, "Id"), params)) {
                                                    return [2 /*return*/, true];
                                                }
                            ...
                            return __generator(this, function (_c) {
                                switch (_c.label) {
                                    ...
                                    case 1:
                                        ...
                                        fns_6 = __values(fns), fns_6_1 = fns_6.next();
                                        _c.label = 2;
                                    case 2:
    ...
    TreeStore.prototype.translateSorter = function (entity, sorter, context, params) {
        var _this = this;
     ...
     * @param context
     */
    TreeStore.prototype.addToResultSelections = function (entity, rows, context) {
        var _a;
    ...
    TreeStore.prototype.selectAbjointRow = function (entity, selection, context, params) {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        nodeDict = params.nodeDict;
                        filterFn = filter && this.translateFilter(entity, filter, context, params);
                        entityNodes = this.store[entity] ? Object.values(this.store[entity]) : [];
                        nodes = [];
                        _d.label = 1;
                    case 1:
                        _d.trys.push([1, 8, 9, 10]);
                        entityNodes_1 = __values(entityNodes), entityNodes_1_1 = entityNodes_1.next();
                        _d.label = 2;
                    case 2:
                    ...
                    case 5:
                        if (_a) {
                            ...
                            if (exprResolveFns.length > 0) {
                                try {
                                    for (exprResolveFns_1 = (e_9 = void 0, __values(exprResolveFns)), exprResolveFns_1_1 = exprResolveFns_1.next(); !exprResolveFns_1_1.done; exprResolveFns_1_1 = exprResolveFns_1.next()) {
                    ...
                    case 10:
                        ...
                        return [4 /*yield*/, this.formResult(entity, rows, selection, context, params)];
                    case 11:
                        rows2 = _d.sent();
    ...
    TreeStore.prototype.updateAbjointRow = function (entity, operation, context, params) {
        return __awaiter(this, void 0, void 0, function () {
            var data, action, now, _a, id, data2, node2, selection, rows, ids;
            var _this = this;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        data = operation.data, action = operation.action;
                        now = Date.now();
                        _a = action;
                        switch (_a) {
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, this.selectAbjointRow(entity, selection, context, params)];
                    case 3:
                        rows = _b.sent();
                        ...
                        ids.forEach(function (id) {
                            ...
                            if (action === 'remove') {
                                ...
                                var row = node && _this.constructRow(node, context) || {};
                                var data2 = Object.assign(data, {
                                    $$updateAt$$: data.$$updateAt$$ || now,
                                });
                                var data3 = Object.assign(row, data2);
                                node.$next = data3;
                                if (!alreadyDirtyNode) {
                                    // 如果已经更新过的结点就不能再加了，会形成循环
                                    _this.addToTxnNode(node, context, 'remove');
    ...
    TreeStore.prototype.doOperation = function (entity, operation, context, params) {
        return __awaiter(this, void 0, void 0, function () {
            var action;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1: return [4 /*yield*/, this.cascadeUpdate(entity, operation, context, params)];
                    case 2: return [2 /*return*/, _a.sent()];
                }
            });
        });
    };
    TreeStore.prototype.operate = function (entity, operation, context, params) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        (0, assert_1.assert)(context.getCurrentTxnId());
                        return [4 /*yield*/, this.doOperation(entity, operation, context, params)];
    ...
    TreeStore.prototype.formResult = function (entity, rows, selection, context, params, nodeDict) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 8:
                        // 再计算sorter
                        if (sorter) {
                            sorterFn = this.translateSorter(entity, sorter, context, params);
                            rows2.sort(sorterFn);
                        }
    ...
    TreeStore.prototype.select = function (entity, selection, context, params) {
        return __awaiter(this, void 0, void 0, function () {
            var result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        (0, assert_1.assert)(context.getCurrentTxnId());
                        return [4 /*yield*/, this.cascadeSelect(entity, selection, context, params)];
                    case 1:
                        result = _a.sent();
                        return [2 /*return*/, {
                                result: result,
    ...
    TreeStore.prototype.count = function (entity, selection, context, params) {
        return __awaiter(this, void 0, void 0, function () {
            var result;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    TreeStore.prototype.sync = function (opRecords, context) {
        return __awaiter(this, void 0, void 0, function () {
            var opRecords_1, opRecords_1_1, record, _a, e, d, _b, e, d, f, _c, e, f, d, _d, _e, _i, entity, _f, _g, _h, id, e_11_1;
            var e_11, _j;
            return __generator(this, function (_k) {
                switch (_k.label) {
                    case 0:
                        ...
                        _k.label = 1;
                    case 1:
                        _k.trys.push([1, 19, 20, 21]);
                        opRecords_1 = __values(opRecords), opRecords_1_1 = opRecords_1.next();
                        _k.label = 2;
                    case 2:
                        if (!!opRecords_1_1.done) return [3 /*break*/, 18];
                    ...
                    case 3:
                        ...
                        return [4 /*yield*/, this.doOperation(e, {
                                action: 'create',
                                data: d,
                            }, context, {
                                notCollect: true,
                    ...
                    case 11:
                        ...
                        id = _f[_h];
                        return [4 /*yield*/, this.doOperation(entity, {
                                action: 'create',
                                data: d[entity][id],
                            }, context, {
                                notCollect: true,
